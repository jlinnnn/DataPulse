...
> This is the **backend** half of DataPulse. It serves JSON (mostly [Plotly](https://plotly.com/python/) figure specs) that the [frontend](../frontend) renders as interactive charts. See the [top-level README](../README.md) for the whole project.
...
git clone https://github.com/jlinnnn/DataPulse.git
